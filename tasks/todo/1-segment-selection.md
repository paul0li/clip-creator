# Card 1: Select 3 Candidate Segments from Transcript
...
Given a full episode transcript with timestamps, automatically select 3 candidate segments (25-40 seconds each) and output their start/end timestamps with a short rationale for each. No video processing happens in this card.
